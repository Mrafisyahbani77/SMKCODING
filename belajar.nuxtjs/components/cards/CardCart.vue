...
<div class="flex items-center border border-gray-300 w-max rounded-
full">

<button class="cursor-pointer py-1 pl-4 pr-2 text-lg flex items-
center justify-center">-</button>

<div class="py-1 px-2 text-lg flex items-center justify-
center">1</div>

<button class="cursor-pointer py-1 pl-2 pr-4 text-lg flex items-
center justify-center">+</button>
